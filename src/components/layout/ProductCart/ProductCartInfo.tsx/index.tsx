...
export function ProductCartInfo({productName, productDescription, moneyToBeSaved, totalOnCredit}: ProductCartInfoProps) {
  ...
  return (
    <div className="w-full max-w-2xl justify-between flex flex-col h-full py-8 gap-3">
        ...
        <div>
          <span className="flex">
            <Price text="Pague com pix e economize até 15%:" price={moneyToBeSaved} />
          </span>
          <span className="flex">
            <Price text="Parcele sua compra em até 10x com segurança pelo Mercado Pago:" price={totalOnCredit} />
          </span>
        </div>
    </div>
  )
