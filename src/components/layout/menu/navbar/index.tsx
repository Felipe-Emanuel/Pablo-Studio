...
export function NavBar() {
  const style = {
    background:
      "linear-gradient(180deg, #121214 0%, rgba(170, 170, 170, 0) 100%)",
  };
  ...
  return (
    ...
    >
      ...
      <Link
        href="/"
        className="z-10 flex items-center justify-center flex-1 absolute left-1/2 transform -translate-x-1/2"
      >
        <Logo />
      </Link>
